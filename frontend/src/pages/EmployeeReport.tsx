                ...
                <div key={main.attemptId} className="card" style={{ marginBottom: '1rem' }}>
                  ...
                  {children.length > 0 && (
                    <div style={{ marginTop: '1rem', paddingLeft: '1rem', borderLeft: '3px solid #ffc107' }}>
                      ...
                      {children.map((fu) => (
                        <div key={fu.attemptId} style={{ marginBottom: '0.75rem', padding: '0.75rem', backgroundColor: '#fffbf0', borderRadius: '4px' }}>
                          ...
                          <div style={{ marginTop: '0.25rem' }}>
                            <strong>Оценка уточнения:</strong> {fu.score != null ? fu.score.toFixed(2) : '—'}
                          </div>
                          {fu.feedback && (
                            <div style={{ marginTop: '0.25rem' }}>
                              <strong>Рекомендация:</strong>
                              <div className="rich-content" dangerouslySetInnerHTML={{ __html: plainTextToHtml(fu.feedback) }} />
                            </div>
                          )}
                        </div>
                      ))}
