  ...
  const cards = [
    {
      ...
      title: 'Компетенции',
      desc: 'Управление компетенциями, критериями и уровнями требований',
    },
    {
      to: '/admin/employees',
      title: 'Заявки',
      desc: 'Учёт сотрудников и генерация пригласительных ссылок',
    },
    {
      to: '/admin/applications',
      title: 'Результаты',
      desc: 'Просмотр завершённых оценок и отчётов по сотрудникам',
    },
  ]
