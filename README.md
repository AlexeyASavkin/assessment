...
|-----------|--------|------------|
| `opencode` (default) | `deepseek-v4-flash` | Основной провайдер. OpenAI-совместимый API шлюза OpenCode (`https://opencode.ai/zen/v1`), платная модель DeepSeek V4 Flash. Ключ: `OPENCODE_API_KEY` |
